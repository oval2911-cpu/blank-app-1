...
dhs.hist(figsize=(15, 10), bins=30, edgecolor='black')
plt.suptitle('Distributions of all numeric variables (continuous and encoded categorical)', fontsize=20)
plt.tight_layout()
plt.show()
...
A	[NaN, 0, 0]	Missing at p1, both later periods are 0	p1 → 0
B	[0, NaN, 0]	p1=0, missing at p2, p3=0	p2 → 0
C	[?, 1, NaN]	p2=1, missing at p3	p3 → 1
D	[1, NaN, ?]	p1=1, missing at p2	p2 → 1
